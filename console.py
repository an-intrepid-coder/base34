...
class Console: 
    def __init__(self, lines):
        self.messages = [
            ...
            Message("gene-locked to their holders. But there are sure to be weapons of some kind nearby...", 0),
    ...
    def push_controls(self):
        if not self.pushed_controls_last:
            self.messages.extend([
                ...
                Message("* press shift+'f' to enable Non-Lethal Overwatch or ctrl+'f' to enable Lethal Overwatch. ", 0),
                Message("  This automatically uses the enabled attack on enemies who wander into your weapon range ", 0),
                Message("  and can see you (ignores ones who can't); provided you have the TU when you end your turn.", 0),
                Message("  pressing 'f' by itself cancels all overwatch. (will add HUD buttons for this soon-ish).", 0),
                Message("* Knife attacks cost no TU!"),
                ...
                Message("* Body Armor will stop a lethal attack, but then may need to be replaced...", 0),
                ...
                Message("* Baddies will sometimes drop information if you stay out of sight and watch them.", 0),
